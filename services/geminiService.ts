...
export const generateGuideContent = async (topic: string, userDescription?: string): Promise<GuideData> => {
  if (!process.env.API_KEY) {
    throw new Error("מפתח API חסר. אנא ודא שהגדרת את ה-API Key בסביבת העבודה.");
  }
